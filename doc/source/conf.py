...
try:
    ...
    raise RuntimeError("Cannot import 'patchwork', please investigate.")
...
release_info = {}
execfile(os.path.join(os.pardir, os.pardir, "patchwork", "info.py"), release_info)
...
html_title = "Patchwork"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "Patchwork"
...
htmlhelp_basename = 'patchwork-doc'
...
latex_documents = [
  ('index', 'patchwork.tex', u'Patchwork Documentation',
   u'apwal', 'manual'),
]
